...
const BannerStory: React.FC<{ data: BannerProps }> = ({ data }) => {
  const bannerImage = getTemplateFileName(data.dia, "story") || "/templates/placeholder.jpg"; // Usa placeholder se for null

  return (
    <div className="banner-wrapper story">
      {bannerImage && (
        <img
          src={bannerImage}
          alt={`Banner ${data.dia}`}
      ...
      <div className="overlay-text story">
